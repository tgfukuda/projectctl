...
export type BrowserType = "brave" | "chrome" | "firefox" | "safari" | "edge" | "opera" | "vivaldi";
...
export abstract class BaseBrowser {
    ...
    async getUrlsToOpen(): Promise<string[]> {
        ...
        try {
            ...
            console.warn(`プロファイルディレクトリの確認中にエラーが発生しました: ${error}`);
        }
    ...
    async launch(): Promise<number | undefined> {
        ...
        console.log(this.getBrowserCommand(), browserArgs, urlsToOpen);
